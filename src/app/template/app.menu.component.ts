    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                ...
                items: [
                    {
                        label: 'Lancamento', icon: 'pi pi-send',
                        items: [
                            {label: 'Cadastro', icon: 'pi pi-money-bill', routerLink: ['lancamento/cadastro']},
                            {label: 'Consulta', icon: 'pi pi-search-plus', routerLink: ['lancamento/consulta']},
                        ]
                    },
                    {
                        label: 'Categoria', icon: 'pi pi-book',
                        items: [
                            {label: 'Cadastro', icon: 'pi pi-save', routerLink: ['categoria/cadastro']},
                            {label: 'Consulta', icon: 'pi pi-search-plus', routerLink: ['categoria/consulta']},
                        ]
                    },
